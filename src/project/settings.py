...
SECRET_KEY = 'django-insecure-@9%1fj)218p4w2gswlx6y)yn8g+k)75z0z&$79%tue*25giuk9'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'accounts.context_processors.site_logo',
            ],
        },
    },
]
...
ADMIN_ORDERING = (
    # ('accounts', ('Account', 'Phone', 'SocialAccount')),
    ('accounts', ('Account',)),
    # ('centersplaces', ('Government', 'Center', 'Class', 'Dates')),
    ('centersplaces', ('Center',)),
    ('booksplaces', ('Library', 'Book')),
    ('news', ('Notification', )),
    ('auth', ('User', 'Group')),
